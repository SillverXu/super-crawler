...
public class TaskBean {
    ...
    public TaskBean( String url_start, String url_end,int requesttype, Map requestParams, int pages, CrawlerBean crawlerBean, boolean isPinjie, String pinjieStr,List<RuleBean> ruleList) {
